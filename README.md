...
[![ADRs](https://img.shields.io/badge/ADRs-72-8A2BE2)](docs/ARCHITECTURE.md)
...
docs/                           # ARCHITECTURE.md (72 ADRs), FORKING.md, COMMANDS.md, diagrams/
```
...
- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — every technical decision
  (ADR-001 → ADR-063), kept in sync with the code at all times.
